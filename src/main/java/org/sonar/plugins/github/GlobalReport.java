...
public class GlobalReport {
    ...
    public GlobalReport(String moduleName, MarkDownUtils markDownUtils, boolean tryReportIssuesInline) {
        this(moduleName, markDownUtils, tryReportIssuesInline, GitHubPluginConfiguration.MAX_GLOBAL_ISSUES);
    }
    ...
    public String formatForMarkdown() {
        ...
        builder.append("SonarQube analysis reported ").append(newIssues).append(" issue").append(newIssues > 1 ? "s" : "")
                .append(" in module ").append(moduleName).append("\n");
